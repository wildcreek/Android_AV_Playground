    ...
    protected void onResume() {
        ...
        threadPool.execute(new Runnable() {
            ...
            public void run() {
                ...
                mOrientationListener = new OrientationEventListener(CaptureCameraActivity.this , SensorManager.SENSOR_DELAY_NORMAL) {
                    @Override
                ...
                setCameraDisplayOrientation(CaptureCameraActivity.this , 1,camera);
                try {
